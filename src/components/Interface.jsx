...
export const Interface = (props) => {
  ...
  return (
    <div className="flex flex-col items-center w-screen">
      <AboutSection setSection={setSection} className="my-8" />
      <SkillsSection className="my-8" />
      <ProjectsSection className="my-12" />
      <ContactSection className="my-8" />
    </div>
  );
};
...
const AboutSection = (props) => {
  ...
  return (
    <Section mobileTop>
      ...
      >
        I'm a Computer Science student in MIT Manipal. Skilled in ML and Python, I
        can working in C/C++, Python, Java, JavaScript, GO and Rust. Passionate about
        development and ML, I'm committed to excellence in any field I work.
      </motion.p>
...
const skills = [
  ...
  {
    title: "Databases(SQL/Oracle/NoSQL)",
    level: 80,
  },
  {
...
const ContactSection = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        "service_upl8bhq", // Replace with your service ID
        "template_6l35hsp", // Replace with your template ID
        {
          from_name: name,
          from_email: email,
          to_name: "Amulya",
          to_email: "amulyaparashar2k4@gmail.com",
          message: message,
        },
        "Yg4hbyq-a71ni_IywDPs8" // Replace with your public key
      )
      .then(() => {
      ...
      .catch((error) => {
        toast.update(toastId, {
          render: `Error sending email: ${error.text || "Something went wrong"}`,
          type: "error",
          isLoading: false,
          autoClose: 5000,
        });
